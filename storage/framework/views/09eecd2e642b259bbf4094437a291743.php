                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item <?php echo e($key == 0 ? 'active':''); ?>">
                            <div class="col-sm-6">
                                ...
                                <h2><?php echo e($sliderItem->name); ?></h2>
                                <p><?php echo e($sliderItem->description); ?></p>
                                <button type="button" class="btn btn-default get">Get it now</button>
                            </div>
                            <div class="col-sm-6">
                                <img src="<?php echo e($sliderItem->image_path); ?>" class="girl img-responsive" alt=""/>
                            </div>
                        </div>
...
</section><!--/slider--><?php /**PATH D:\shop\resources\views/auth/components/slider.blade.php ENDPATH**/ ?>